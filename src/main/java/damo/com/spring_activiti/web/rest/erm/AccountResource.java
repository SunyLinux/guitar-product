...
import damo.com.spring_activiti.domain.erm.PersistentToken;
import damo.com.spring_activiti.domain.erm.User;
import damo.com.spring_activiti.repository.erm.PersistentTokenRepository;
import damo.com.spring_activiti.repository.erm.UserRepository;
import damo.com.spring_activiti.security.SecurityUtils;
import damo.com.spring_activiti.service.MailService;
import damo.com.spring_activiti.service.dto.UserDTO;
import damo.com.spring_activiti.service.erm.UserService;
import damo.com.spring_activiti.web.rest.util.HeaderUtil;
import damo.com.spring_activiti.web.rest.vm.KeyAndPasswordVM;
import damo.com.spring_activiti.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public ResponseEntity<?> registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM, HttpServletRequest request) {
        ...
        return userRepository.findOneByLogin(managedUserVM.getLogin().toLowerCase())
            .map(user -> new ResponseEntity<>("Account Already Exists", textPlainHeaders, HttpStatus.BAD_REQUEST))
            .orElseGet(() -> userRepository.findOneByEmail(managedUserVM.getEmail())
                .map(user -> new ResponseEntity<>("E-Mail Already Exists", textPlainHeaders, HttpStatus.BAD_REQUEST))
                .orElseGet(() -> {
                    ...
                    managedUserVM.getLangKey(),managedUserVM.getTenancyCode(),managedUserVM.getOrgName());
